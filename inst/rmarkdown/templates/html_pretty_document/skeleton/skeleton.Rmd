...
<img src="cien-logo.png" style="position:absolute;top:0;right:0; padding:5px;max-height:20%; max-width:20%;" />
...
stylish than `html_vignette` when creating package vignettes. This is an adaptation of those formats to suit the need of CIEN
